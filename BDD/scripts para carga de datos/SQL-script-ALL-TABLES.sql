insert into ciudades (nombre, nombre_pais) values 
	("Rosario", "Argentina"),
	("Cordoba", "Argentina"),
...
insert into categorias (titulo, descripcion, url_imagen) values 
	("Deportivo", "Autos deportivos", "https://s1.1zoom.me/big0/862/BMW_3-Series_F30_Blue_White_background_Sedan_539036_1280x720.jpg"),
	("Lujoso", "Autos Lujosos", "https://s1.1zoom.me/big0/222/KIA_Rio_(FB)_2020_Red_Metallic_White_background_594272_1280x853.jpg"),
	("Economico", "Autos Economicos", "https://cdn.group.renault.com/ren/co/vehicles/kwid/home/renault-kwid-gris-estrella.jpg.ximg.xsmall.jpg/2df0020f6d.jpg"),
	("Electrico", "Autos Electricos", "https://i.pinimg.com/originals/eb/93/f3/eb93f36016170bee38975f6f51499e2a.jpg");
...
INSERT INTO caracteristicas (nombre, icono) VALUES
  ('Estrellas', 'faStar'),
  ('Ubicacion', 'faMapMarked'),
  ('Wi-Fi', 'faWifi'), 
  ('Carro', 'faCar'),
  ('Flecha', 'faChevronLeft'),
  ('Corazón', 'faHeart'), 
...
INSERT INTO usuarios(nombre, apellido, email, password) VALUES
  ('nadia', 'ojeda', 'nadie@mail', '1234'),
  ('carla', 'benitez', 'carli@mail', 'abcd'),
  ('pedro', 'perez', 'pepe@mail', '1a2b3c'), 
  ('tomas', 'gimenez', 'toto@mail', 'sarasa'),
  ('carlos', 'gomez', 'cacho@mail', 'noviembre'),
  ('cecilia', 'mendez', 'ceci@mail', 'arq'), 
  ('susana', 'juncos', 'popy@mail', '2021'),
  ('benito', 'rodriguez', 'benito@mail', 'dcba'),
  ('maria', 'lopez', 'maria@mail', 'zaza'), 
  ('melisa', 'romero', 'meli@mail', '2b3c');
